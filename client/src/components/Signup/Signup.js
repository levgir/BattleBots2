            ...
            <div>
                ...
                <Form>
                    <FormGroup>
                        ...
                        <Input type="text" name="firstname" id="firstname" placeholder="Tu nombre?" value={this.props.firstname} onChange={this.props.handleInputChange} valid={this.state.validFirstname} />
                    </FormGroup>
                    <FormGroup>
                        <Label for="lastname"> Can we get a last name? </Label>
                        <Input type="text" name="lastname" id="lastname" placeholder="Tu apellido?" value={this.props.lastname} onChange={this.props.handleInputChange} valid={this.state.validLastname} />
                    </FormGroup>
                    <FormGroup>
                        <Label for="email"> What about an email? </Label>
                    ...
                    <FormGroup>
                        <Label for="username"> What do you wanna be called though? </Label>
                        <Input type="text" name="username" id="username" placeholder="Nickname coming right up" value={this.props.username} onChange={this.props.handleInputChange} valid={this.state.validUsername} />
                    </FormGroup>
                    <FormGroup>
                        <Label for="password"> Can you keep a secret? </Label>
                        <Input type="password" name="password" id="password" placeholder="Your password will go here!" value={this.props.password} onChange={this.props.handleInputChange} valid={this.state.validPassword} />
                        <FormText>{this.state.passwordMessage}</FormText>
                    </FormGroup>
                    <FormGroup>
                        <Label for="confirmPassword">What's the password? </Label>
                        <Input type="password" name="password" id="confirmPassword" placeholder="Now let's confirm that password" value={this.state.password} onChange={this.handleInputChange} valid={this.state.confirmPassword} />
                    </FormGroup>
                    ...
                    {(this.state.validFirstname && this.state.validLastname && this.state.validEmail && this.state.validUsername && this.state.validPassword && this.state.confirmPassword) ? (
                        <Button onClick={this.props.handleSignup} color="success" block>Sign me up! </Button>
                    ) : (
                        <Button onClick={this.props.handleSignup} color="danger" block disabled>Signup</Button>
                    )}
                    <p className="signupLink">
                        <Link to="/login">Do you already have an account? You can sign in here. Don't worry, we'll take you back. </Link>
                    </p>
                </Form>
            </div>
        );
